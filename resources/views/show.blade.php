        ...
        <div class="lg:ml-12 lg:mr-64">
            ...
            <div class="text-gray-400">
                <span>
                    ...
                    &middot; {{-- Separate genres and platforms --}}
                <span>
                    {{$game['platforms']}}
                </span>
                    &middot;
            ...
            <div class="flex flex-wrap items-center mt-8 ">
                <div class="flex items-center">
                    <div id="memberRating" class="w-16 h-16 bg-gray-800 rounded-full relative text-sm"> {{-- Animated member rating --}}
                        @push('scripts')
                        @include('_rating', [
                        'slug' => 'memberRating',
                ...
                <div class="flex items-center ml-6 mr-12">
                    <div id="criticRating" class="w-16 h-16 bg-gray-800 rounded-full relative text-sm"> {{-- Animated critic rating --}}
                        @push('scripts')
                            @include('_rating', [
                            'slug' => 'criticRating',
