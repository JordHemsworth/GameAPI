...
@section('content')
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="popular-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-12 border-b border-gray-800 pb-16">                                          {{-- Create a 6 wide grid used to display all covers --}}
            <div class="game mt-8">
